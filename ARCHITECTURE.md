...
- **La dirección de arte vigente es [`md/v3/art-direction/`](md/v3/art-direction/illustrations.md)**, y son dos documentos con papeles distintos: [`style-guide.md`](md/v3/art-direction/style-guide.md) es la *biblia visual* —**cómo** se dibuja: línea, anatomía, color, materiales, luz— y gobierna todo el arte del juego; [`illustrations.md`](md/v3/art-direction/illustrations.md) es **qué** se dibuja —razas, héroes de clase, unidades, criaturas y cartas, con su encuadre, su plantilla de prompt y dónde se guarda el archivo— y es donde se escribirán los bloques sujeto a sujeto. Hay un tercer papel que **no existe todavía**: el *diseño de la carta* como objeto (marco, tipografía, disposición del nombre y el coste, tratamiento de la Rareza). V3 no lo ha decidido, y por eso la ilustración arrastra el lienzo heredado de v2. Los *prompts* de v2 (`md/v2/art-direction/`, más su lámina de calibración) son catálogo de aquella versión y están congelados: sus categorías Arma, Armadura y Mercenario ni siquiera existen en V3, y **no se traducen**. Hay **una sola biblia**, no una por versión, porque el estilo no cambió al cambiar el motor de reglas: V3 se dibuja igual que v2, lo que cambia es a quién. Por eso los prompts congelados de v2 apuntan hacia adelante, a la guía que vive con V3.
...
md/                         # papeles de trabajo: NO se indexan en la wiki
├── v2/                     # art-direction/ (prompts congelados + lámina) + PLAN-COMBATE archivado
└── v3/                     # art-direction/ (biblia visual + ilustraciones) + el plan de migración, ya ejecutado
```
