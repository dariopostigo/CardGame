...
([`docs/v3/game-design.md`](../../../docs/v3/game-design.md) §4.2)— y lo que hace
que la mayoría de los números de las 132 fichas se muevan en márgenes estrechos y
comparables.
...
([`docs/v3/game-design.md`](../../../docs/v3/game-design.md) §3), así que su ❤️ y su
⚔️ salen de la base de **su raza** aplicando la curva de un tier N, el mismo para los
44. Con eso, lo que distingue a las cuatro clases de una raza pasa a ser **lo que no
escala** —🛡️ 🔮 🎯 🍀 ⚡ y sus Características—, que es lo que ya las distinguía en
...
combate está en
[`docs/v3/game-design.md`](../../../docs/v3/game-design.md) §4.3.
...
como están —**cero fichas cambian**— y es el mismo trato que recibió el encuadre
de la ficha el mismo día: una regla derivada que reproduce lo que la mano ya había
hecho encodea la intención en vez de sustituirla. El precio va dicho y es
**holgura cero**: una unidad nueva de tier 5 con cuatro rasgos rompe el tope, y
que salte es la conversación, no el fallo.
...
coste. Importa para lo que viene, porque **las sub-facciones van a traer más
etiquetas**.

**Está comprobado y no prometido**: `capViolations()` en `lib/v3/traits.ts` lee
este documento y mide las 132 contra la tabla. Hoy devuelve vacío.

> **Lo que la cuenta destapó de paso, y no es del tope.** Tres fichas llevan un
> rasgo que otro suyo ya implica: 🐀 Hombres rata ☠️ *Alquimista* y 💀 No-muertos
> ☠️ *Abominación* y 🐉 *Dragón esquelético*. Las dos últimas llevan 💀 *No-muerto*
> **y** 😱 *Inmune al miedo*, cuando el primero ya dice «es inmune al miedo»; el
> Alquimista lleva ☠️ *Inmune al veneno* y ☠️ *Resistente al veneno*, y la
> inmunidad se come a la resistencia. El 🐉 Dragón esquelético es además una de las
> cinco fichas que tocan el tope, o sea que **gasta su quinta plaza en repetirse**.
> No se toca aquí: es asignación, y va con el repaso de las 132.
