# Razas — documento de trabajo

> **Esto no es la wiki.** Es el borrador donde se define el sistema de razas
> antes de tocar [`docs/v3/razas.md`](../../../docs/v3/razas.md), que sigue
> siendo la versión publicada y no se edita hasta que lo de aquí esté cerrado.
> Lo que falta por decidir está en [`README.md`](README.md).
>
> Copia de partida tomada de `docs/v3/razas.md` el 20 de agosto de 2026.
...
Este documento define cuatro cosas, en este orden:
...
3. **El catálogo de Características** — los rasgos con nombre fijo que se reparten entre las fichas.
4. **Las unidades** — la progresión de 8 por raza, con las Características de cada una.

> **Los valores numéricos de las Habilidades no están aquí**: siguen pendientes. Lo que sí está cerrado es la asignación de Características, tanto para héroes como para unidades, de las 10 razas.

Las decisiones de rumbo que enmarcan este documento —los dos tableros, qué tipos de carta desaparecen, cómo funciona la progresión— viven en [game-design.md](../../../docs/v3/game-design.md). Lo que falta por decidir está en [status.md](../../../docs/v3/status.md).
