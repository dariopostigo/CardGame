...
// =========================================================================
// Laboratorio de ANIMACIÓN DE PERSONAJE — /dev/sprite
//
// Preview aislado, sin tablero: recorta la lámina de referencia
// (public/assets/sprites/dwarf-warrior-reference.png) en sus 20 fotogramas
  ...
  return (
    <div>
      ...
      <p className="mb-5 max-w-3xl text-sm text-[var(--wiki-muted)]">
        ...
        <code>public/assets/sprites/dwarf-warrior-reference.png</code> (lámina de referencia de
