...
//
// Vive en components/dev/ porque el jugador no ve losetas sueltas: solo ve el
...
// clicables los lados.
//
// Aquí no se decide nada: la geometría la pide a lib/rules/hex.ts, lo que
...
import type { PlacedEdge } from "@/lib/rules/tiles";
