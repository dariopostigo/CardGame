...
// characters/enemies.md §5b.6, lib/v2/rules/enemy-ai.ts) antes de devolver el
...
//
// 2. **La figura 3D sobre el tablero** (components/lab/battle-figure-scene.ts):
...
import {
  ...
  type Weapon,
} from "@/lib/v2/rules/combat";
import {
  computeAttackAdvantage,
  decideEnemyAction,
  type EnemyAction,
  type EnemyDecisionContext,
} from "@/lib/v2/rules/enemy-ai";
import {
  ENEMY_CLASS_IDS,
  ENEMY_ROSTER,
  resistancesFor,
  ...
  type EnemyClassDef,
  type EnemyClassId,
} from "@/lib/v2/rules/enemy-roster";
import {
  blockFor,
...
} from "@/lib/v2/rules/mercenary-roster";
import { applyEffect, applyStartOfTurnDamage, attemptEndOfTurnSaves, hasEffect, type Effects } from "@/lib/v2/rules/effects";
import { abilityMod, HERO_CLASS_IDS, HERO_ROSTER } from "@/lib/v2/rules/hero-roster";
import { attackableTargets, MOVE_BASE, reachableHexes } from "@/lib/v2/rules/movement";
import { abilityCheck } from "@/lib/v2/rules/skill-check";
import * as Rng from "@/lib/v2/rules/rng";
import type { Ability, AbilityScores, Board, CreatureNature, HeroClassId, Hex as HexCell } from "@/lib/v2/rules/state";
...
function CombatSession({
  ...
  // Qué enemigos ya podrías golpear ESTE turno (lib/v2/rules/movement.ts
