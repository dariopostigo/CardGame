...
// =========================================================================
// Laboratorio de TIRADA DE DADOS — /lab/dice
//
...
//
// Deliberadamente NO conectado a lib/v2/rules/rng.ts: ese motor es
  ...
  return (
    <div>
      ...
      <p className="mb-5 max-w-3xl text-sm text-[var(--wiki-muted)]">
        ...
        lleva cada una — ver <code>components/lab/dice-geometry.ts</code>.
      </p>
