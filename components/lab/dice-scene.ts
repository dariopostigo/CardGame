...
//
// Este motor no toca lib/v2/rules/: es un banco de pruebas de la TÉCNICA
...
// lib/v2/rules/rng.ts, no algo que este laboratorio deba resolver.
// =========================================================================
...
// de una sola línea—. Verificado a ojo en /lab/dice: con el signo correcto
...
export function buildPolyhedronVisual(model: DiceModel, color: string) {
  ...
  // sin encoger más: a ojo en /lab/dice pedía solo números más finos, no más
