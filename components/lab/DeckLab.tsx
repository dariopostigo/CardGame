...
// =========================================================================
// Laboratorio de Mazo y Oteo — /lab/deck
//
// Banco de pruebas de lib/v2/rules/deck.ts: elige un héroe y comprueba el Mazo
...
// mismas cartas: ver la nota de lib/v2/rules/deck.ts sobre por qué no usa items
// reales todavía.
// =========================================================================
...
import {
  ...
  type DeckState,
  type OteoDraw,
} from "@/lib/v2/rules/deck";
import { HERO_CLASS_IDS, HERO_ROSTER } from "@/lib/v2/rules/hero-roster";
import type { HeroClassId } from "@/lib/v2/rules/state";
    ...
    <div className={`card-lab deck-lab ${cardFontVars}`} data-theme={DEFAULT_CARD_THEME}>
      ...
      <div className="card-lab__stage deck-lab__stage">
        ...
        {/* Centro de la mesa: el tablero es una simulación —este lab prueba
            lib/v2/rules/deck.ts, no hay tablero real todavía— solo para que
