...
// =========================================================================
// Laboratorio de MOVIMIENTO Y VISIÓN — /lab/movement
//
// Banco de pruebas de lib/v2/rules/movement.ts y lib/v2/rules/vision.ts: 1-4
// héroes co-op (characters/heroes.md §4) empiezan en la entrada del tablero
// de /lab/board y se mueven a golpe de clic, cada uno con su propio turno
...
// /lab/board— ni el combate ni la activación de enemigos (§4b.5,
// /lab/combate, todavía sin motor). Tampoco modela Oteo/Acción: no lo hacía
...
import { TERRAINS, TERRAIN_IDS } from "@/lib/v2/rules/terrain";
import { MOVE_BASE, movePointsForTurn, reachableHexes, type ReachableInfo } from "@/lib/v2/rules/movement";
import { revealFromPosition, visionRadii } from "@/lib/v2/rules/vision";
            ...
            <li>
              ...
              {cell.token === "enemigo" && (
                <>
                  ...
                  amenaza): eso llega con el motor de combate (<code>/lab/combate</code>,
                  hoy planificado).
                </>
              )}
            </li>
