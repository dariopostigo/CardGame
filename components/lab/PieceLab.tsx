...
// =========================================================================
// Laboratorio de DISEÑO DE FICHAS — /lab/pieces
//
...
// «De partida» al lado.
//
// Vive en components/lab/ porque es instrumental: las fichas que pinta sí son
  ...
  return (
    <div>
      ...
      <p className={note}>
        ...
        <Link href="/docs/v2/characters/enemies" className="text-[var(--wiki-accent)] hover:underline">
          Enemigos §2
        </Link>
