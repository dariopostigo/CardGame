...
// Mover a "v3" a la vez que DESIGN_LAB_GROUP en lib/docs.ts. El destino es
// app/docs/v3/cards/design/ (CardDesign), que desde el 3 de septiembre de 2026
// es la única página de cartas de V3: ese día absorbió a "Diseño baraja".
