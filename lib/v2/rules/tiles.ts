...
// encaja es board-gen.ts; quien las enseña y las edita es /lab/tiles.
//
 ...
 * que manda el editor de /lab/tiles por la ruta de guardado: los datos vienen
 ...
 * `parseLibrary`, y se usa para dos cosas —guardar lo que edita /lab/tiles y
 ...
 * que pasa todo lo que se guarda: la llama la ruta de /lab/tiles antes de
 ...
 * `validateTileTypes` y también el editor de /lab/tiles, que la llama sobre el
