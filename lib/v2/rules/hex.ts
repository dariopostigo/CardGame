...
// cuadriculado sobre la que se dibuja una loseta a mano en /lab/tiles y en
// la que `drawn()`/`toDrawing()` (lib/v2/rules/tiles.ts) leen y escriben el
...
// (/lab/tiles) enseña la PIEZA, no la mesa, y ahí la inclinación estorba:
