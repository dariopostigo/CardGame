...
## Nuevo cambio de rumbo en el juego

1. Me gustaria mas centrar el desarrollo del video juego entre un Heroes might and magic olden era y Magic The gathering, modificando a mi gusto el modo de juego. Vamos a ir marcando las bases del juego que serian la definicion de razas que las primeras serian las que te voy a contar a continuacion, las habilidades de los personajes (personajes se refiere tanto a los heroes como a los enemigos y mercenarios) y tambien las caracteristicas de los personajes, esto hay que definirlo ya que mi intencion seria poner algo tipo Life-steal (obtiene un porcentaje como vida del daño causado), No-muerto (Inmune a algo que decidamos) Criatura voladora (Definir) etc etc etc. Con todo esto tendriamos las base para realizar las acciones de combate.
2. El tablero de batalla seguira siendo de momento el mismo y se diferenciara en dos: Tablero de exploracion y Tablero de batalla.
3. El sistema de cartas seguira siendo la misma pero habria que realizar los cambios para adaptarlos al nuevo sistema de habilidades y caracteristicas de los personajes.
4. Las cartas de clases habria que adaptarlas a todos los personajes y razas que se describen mas abajo.
5. Cada raza va a tener sus propias unidades desde la mas debil hasta la mas fuerte, habria que crear una carta de unidad por cada una de ellas.
6. Las cartas de mercenarios quedan de momento obsoletas hasta nuevo aviso.
...
- 🗡️ **Asesino** — Movilidad / crítico / sigilo
...
- ⚔️ **Ataque** — Daño físico que inflige.
- 🛡️ **Defensa** — Reduce el daño físico recibido.
- 🔮 **Resistencia mágica** — Resistencia a la magia.
- 🎯 **Precisión** — Probabilidad de acertar ataques.
- 🍀 **Suerte** — Probabilidad de golpes críticos o efectos favorables.
- ⚡ **Velocidad** — Determina iniciativa/orden de actuación.
...
- 🩸 **Hemorragia** — Los ataques aplican un efecto que inflige daño adicional durante varios turnos.
...
- 🏹 **Ataque a distancia** — Puede atacar enemigos sin estar adyacente a ellos.
...
- 🧊 **Congelación** — Reduce el Movimiento y puede llegar a impedir que el objetivo actúe.
- 🌑 **Ceguera** — Reduce considerablemente la Precisión del objetivo.
- 🕸️ **Inmovilización** — Impide utilizar Movimiento durante X turnos.
- 🐌 **Lentitud** — Reduce la Velocidad del objetivo.
...
- 😱 **Miedo** — Cuando un enemigo pierde por primera vez la mitad de su Vida, tiene una probabilidad de quedar paralizado durante 1 turno.

### 🛡️ Resistencias e inmunidades
- 🛡️ **Resistente al daño físico** — Reduce el daño recibido de ataques físicos.
- ✨ **Resistente a la magia** — Reduce el daño recibido de ataques mágicos.
...
- 🧪 **Inmune a estados alterados** — No puede sufrir determinados efectos negativos.
...
- 🛡️ **Último aliento** — Al quedar por debajo de un porcentaje de Vida, obtiene temporalmente una bonificación de daño.

### 🔮 Magia
- 🔮 **Resistencia mágica** — Reduce el daño recibido de habilidades mágicas.
...
- 🎯 **Provocación** — Puede obligar a determinados enemigos a atacarlo.
...
| Raza | Héroe | Características |
|---|---|---|
| 👤 Humanos | ⚔️ Guerrero | 🛡️ Resistente al daño físico · 😱 Inmune al miedo · 🛡️ Último aliento |
| 👤 Humanos | 🔮 Mago | 🔮 Resistencia mágica · 🧊 Resistente al frío |
| 👤 Humanos | ✝️ Sacerdote | 🔮 Resistencia mágica · 😱 Inmune al miedo |
| 👤 Humanos | 🏹 Arquero | 🏹 Ataque a distancia · 👁️ Percepción · 💥 Golpe crítico |
| ⛏️ Enanos | ⚔️ Guerrero | 🛡️ Resistente al daño físico · 🛡️ Último aliento |
| ⛏️ Enanos | ⚙️ Ingeniero | 🏹 Ataque a distancia · 👁️ Percepción · 🤖 Constructo |
| ⛏️ Enanos | 🪓 Berserker | 💥 Golpe crítico · 🩸 Hemorragia · 🛡️ Último aliento |
| ⛏️ Enanos | 🔯 Maestro de runas | 🔮 Resistencia mágica · 🛡️ Resistente al daño físico |
| 💀 No-muertos | ⚔️ Guerrero | 💀 No-muerto · 🛡️ Resistente al daño físico · ☠️ Inmune al veneno |
| 💀 No-muertos | 💀 Nigromante | 💀 No-muerto · 🔮 Resistencia mágica |
| 💀 No-muertos | 🩸 Vampiro | 💀 No-muerto · 🩸 Robo de vida · 🪽 Ágil |
| 💀 No-muertos | ☠️ Liche | 💀 No-muerto · 🔮 Resistencia mágica · ☠️ Inmune al veneno |
| 🔥 Demonios infernales | ⚔️ Guerrero | 😈 Demonio · 🔥 Resistente al fuego · 🛡️ Resistente al daño físico |
| 🔥 Demonios infernales | 🧙 Brujo | 😈 Demonio · 🔮 Resistencia mágica · 🔥 Resistente al fuego |
| 🔥 Demonios infernales | 🔥 Inquisidor infernal | 😈 Demonio · 🔥 Resistente al fuego · 😱 Inmune al miedo |
| 🔥 Demonios infernales | 👹 Señor demoníaco | 😈 Demonio · 🔥 Inmune al fuego · 🔮 Resistencia mágica |
| 🧝 Elfos | 🌲 Guardabosques | 🏹 Ataque a distancia · 👁️ Percepción · 🌲 Explorador |
| 🧝 Elfos | 🌿 Druida | 🌲 Explorador · 🧪 Inmune a estados alterados |
| 🧝 Elfos | ✨ Hechicero | 🔮 Resistencia mágica · 🐾 Ágil |
| 🧝 Elfos | 🗡️ Asesino | 🐾 Ágil · 💥 Golpe crítico · 🩸 Hemorragia |
| 🧌 Orkos | 🪓 Bárbaro | 💥 Golpe crítico · 🩸 Hemorragia · 🛡️ Último aliento |
| 🧌 Orkos | 🛡️ Jefe de guerra | 🛡️ Resistente al daño físico · 😱 Inmune al miedo · 👑 Líder |
| 🧌 Orkos | 🔮 Chamán | 🔮 Resistencia mágica · 😱 Inmune al miedo |
...
| 🐀 Hombres rata | 🐀 Señor de la plaga | ☠️ Inmune al veneno · 🧪 Inmune a estados alterados · 🩸 Hemorragia |
| 🐀 Hombres rata | ⚙️ Maquinista | 🏹 Ataque a distancia · 👁️ Percepción · 🐾 Ágil |
| 🤖 Constructos | ⚔️ Autómata de guerra | 🤖 Constructo · 🛡️ Resistente al daño físico · 🧪 Inmune a estados alterados |
| 🤖 Constructos | 🏹 Cañonero | 🤖 Constructo · 🏹 Ataque a distancia · 🗡️ Perforante |
| 🤖 Constructos | ⚙️ Ingeniero arcano | 🤖 Constructo · 🔮 Resistencia mágica · 👁️ Percepción |
| 🤖 Constructos | 🔮 Gólem rúnico | 🤖 Constructo · 🔮 Resistencia mágica · 🧪 Inmune a estados alterados |
| 🧜 Abisales | 🔱 Guardián de las profundidades | 🛡️ Resistente al daño físico · 🌊 Anfibio · 🧊 Resistente al frío |
| 🧜 Abisales | 🐙 Invocador abisal | 🌊 Anfibio · 🔮 Resistencia mágica · 🧪 Inmune a estados alterados |
| 🧜 Abisales | 🌊 Brujo de las mareas | 🌊 Anfibio · 🔮 Resistencia mágica · 🐾 Ágil |
| 🧜 Abisales | 🧠 Devoramentes | 🌊 Anfibio · 🌀 Confusión · 🧠 Aturdimiento |
...
- 🗡️ **Asesino élfico** — Sigilo / crítico / movilidad
...
| Unidad | Características |
|---|---|
| ⛏️ Minero | 🛡️ Resistente al daño físico |
| 🪓 Guerrero enano | 🛡️ Resistente al daño físico |
| 🔨 Herrero de guerra | 🛡️ Resistente al daño físico · 🗡️ Perforante |
| ⚙️ Ingeniero | 🏹 Ataque a distancia · 👁️ Percepción |
| 🔫 Mosquetero | 🏹 Ataque a distancia · 🗡️ Perforante |
| 🛡️ Guardia de hierro | 🛡️ Resistente al daño físico · 🧪 Inmune a estados alterados |
| 🗿 Gólem de piedra | 🤖 Constructo · 🛡️ Resistente al daño físico · 🐌 Lentitud |
| ⛰️ Coloso de adamantita | 🤖 Constructo · 🛡️ Resistente al daño físico · 🧪 Inmune a estados alterados · 🗡️ Perforante |
...
|---|---|
| 🦴 Esqueleto | 💀 No-muerto |
| 🏹 Arquero esqueleto | 💀 No-muerto · 🏹 Ataque a distancia |
| 🧟 Necrófago | 💀 No-muerto · 🐾 Ágil |
| 💀 Guerrero esquelético | 💀 No-muerto · 🛡️ Resistente al daño físico |
...
| Unidad | Características |
|---|---|
| 👿 Diablillo | 😈 Demonio · 🐾 Ágil |
| 🗡️ Guerrero infernal | 😈 Demonio · 🔥 Resistente al fuego |
| 🔥 Sabueso infernal | 😈 Demonio · 🔥 Fuego · 🐾 Ágil |
| 😈 Demonio de batalla | 😈 Demonio · 🔥 Resistente al fuego · 😱 Inmune al miedo |
| 🧙 Brujo infernal | 😈 Demonio · 🔮 Resistencia mágica · 🔥 Fuego |
| 🔥 Demonio de fuego | 😈 Demonio · 🔥 Inmune al fuego · 🔥 Fuego · 🛡️ Resistente al daño físico |
| 👹 Señor demoníaco | 😈 Demonio · 🔥 Inmune al fuego · 🔮 Resistencia mágica · 😱 Inmune al miedo |
| 👹 Balor | 😈 Demonio · 🔥 Inmune al fuego · 🔥 Fuego · 💣 Explosivo · 😱 Inmune al miedo |

### 🧝 Elfos

| Unidad | Características |
|---|---|
| 🏹 Explorador | 🏹 Ataque a distancia · 👁️ Percepción · 🌲 Explorador |
| 🗡️ Guerrero élfico | 🐾 Ágil |
| 🏹 Arquero élfico | 🏹 Ataque a distancia · 👁️ Percepción · 💥 Golpe crítico |
| 🌿 Druida | 🌲 Explorador · 🧪 Inmune a estados alterados |
| 🗡️ Asesino élfico | 🐾 Ágil · 💥 Golpe crítico · 🩸 Hemorragia |
| 🧙 Hechicero élfico | 🔮 Resistencia mágica · 🐾 Ágil |
| 🦄 Unicornio | 🐾 Ágil · 🌲 Explorador · 🧪 Inmune a estados alterados |
| 🌳 Ent ancestral | 🛡️ Resistente al daño físico · 🌲 Explorador · 🧪 Inmune a estados alterados · 🐌 Lentitud |

### 🧌 Orkos

| Unidad | Características |
|---|---|
| 🪓 Guerrero orko | 🩸 Hemorragia |
| 🏹 Cazador orko | 🏹 Ataque a distancia · 👁️ Percepción |
| 🪓 Bárbaro | 💥 Golpe crítico · 🩸 Hemorragia · 🛡️ Último aliento |
| 🐗 Jinete de jabalí | 🐾 Ágil · 💥 Golpe crítico |
| 🔮 Chamán | 🔮 Resistencia mágica · 😱 Inmune al miedo |
| 🩸 Carnicero | 🩸 Hemorragia · 💥 Golpe crítico · 🛡️ Último aliento |
| 🧌 Troll de guerra | 🛡️ Resistente al daño físico · 💚 Regeneración · 😱 Inmune al miedo |
| 👹 Gigante orko | 🛡️ Resistente al daño físico · 💚 Regeneración · 🩸 Hemorragia · 😱 Inmune al miedo |
...
| Unidad | Características |
|---|---|
| 🗡️ Guerrero dracónido | 🔥 Resistente al fuego |
...
| Unidad | Características |
|---|---|
| 🐀 Rata de alcantarilla | 🐾 Ágil |
| 🗡️ Asaltante | 🐾 Ágil · 💥 Golpe crítico |
| 🏹 Tirador de plaga | 🏹 Ataque a distancia · ☠️ Veneno |
| ☠️ Alquimista | ☠️ Veneno · ☠️ Resistente al veneno · 🏹 Ataque a distancia |
| ⚙️ Maquinista | 🏹 Ataque a distancia · 👁️ Percepción · 💣 Explosivo |
| 🐀 Señor de la plaga | ☠️ Inmune al veneno · 🧪 Inmune a estados alterados · ☠️ Veneno |
| 🐀 Rata ogro | 🛡️ Resistente al daño físico · 🩸 Hemorragia · 😱 Inmune al miedo |
| 🧪 Abominación de plaga | ☠️ Inmune al veneno · ☠️ Veneno · 🛡️ Resistente al daño físico · 🩸 Hemorragia · 🧪 Inmune a estados alterados |

### 🤖 Constructos

| Unidad | Características |
|---|---|
| ⚙️ Autómata | 🤖 Constructo |
| 🛡️ Guardián mecánico | 🤖 Constructo · 🛡️ Resistente al daño físico |
| 🏹 Cañonero | 🤖 Constructo · 🏹 Ataque a distancia · 🗡️ Perforante |
| ⚙️ Ingeniero arcano | 🤖 Constructo · 👁️ Percepción · 🔮 Resistencia mágica |
| 🗡️ Autómata de guerra | 🤖 Constructo · 🛡️ Resistente al daño físico · 🗡️ Perforante |
| 🔮 Gólem rúnico | 🤖 Constructo · 🔮 Resistencia mágica · 🧪 Inmune a estados alterados |
| 🗿 Gólem de guerra | 🤖 Constructo · 🛡️ Resistente al daño físico · 🧪 Inmune a estados alterados · 🐌 Lentitud |
| ⚙️ Coloso mecánico | 🤖 Constructo · 🛡️ Resistente al daño físico · 🔮 Resistencia mágica · 🧪 Inmune a estados alterados · 🗡️ Perforante |

### 🧜 Abisales

| Unidad | Características |
|---|---|
| 🐟 Merodeador abisal | 🌊 Anfibio · 🐾 Ágil |
| 🔱 Guerrero de las profundidades | 🌊 Anfibio · 🛡️ Resistente al daño físico |
| 🏹 Cazador abisal | 🌊 Anfibio · 🏹 Ataque a distancia · 🐾 Ágil |
| 🌊 Brujo de las mareas | 🌊 Anfibio · 🔮 Resistencia mágica · 🧊 Congelación |
| 🐙 Invocador abisal | 🌊 Anfibio · 🔮 Resistencia mágica · 🌀 Confusión |
| 🧠 Devoramentes | 🌊 Anfibio · 🌀 Confusión · ⚡ Aturdimiento · 🔮 Resistencia mágica |
| 🦑 Horror de las profundidades | 🌊 Anfibio · 🛡️ Resistente al daño físico · 🕸️ Inmovilización · 🧊 Congelación |
| 🐙 Kraken ancestral | 🌊 Anfibio · 🛡️ Resistente al daño físico · 🕸️ Inmovilización · 🧊 Congelación · 🧪 Inmune a estados alterados |
