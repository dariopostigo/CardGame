...
> **Y le da un segundo trabajo a 👢 Movimiento, que hay que tener delante al escribir la escala:** con 👢 Movimiento igual para todos, el 🏹 dispara y retrocede indefinidamente y el 🗡️ **no contacta nunca** — en un tablero pequeño lo acorralaba el borde, y en 168 hexágonos no hay borde al que llegar. El reparto (🗡️ el más alto, 🏹 el más bajo) es lo que rompe ese bucle, así que no es una preferencia de sabor: es un requisito ([battle.md](board/battle.md) §1.2).
