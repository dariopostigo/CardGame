...
- ~~El lote de semillas~~ **construido y corrido** *(2026-08-10)*: `/dev/tablero` genera cientos de tableros de golpe y mide el reparto en vez del ejemplar. Ya remidió las cifras de 9 losetas / biblioteca vieja que citaban este documento y `board/board-map.md` — los números de abajo y los de `board/board-map.md` §2c son los nuevos, sacados de N=300 por tamaño (12/15/18 losetas).
