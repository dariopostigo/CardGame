...
| Detección (enemigo) | Rango de visión del enemigo; cuando el héroe entra en él se resuelve una **prueba de sigilo** (`characters/enemies.md` §2b) y solo si falla el enemigo se activa (persigue e inicia combate). Reducido por la ocultación del terreno (`characters/enemies.md` §2) |
