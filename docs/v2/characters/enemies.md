...
- Dentro de la **fase enemiga** (`../board/battle.md` §6), cada enemigo actúa en el orden fijado por su propia iniciativa (`../game-design.md` §4b.2) y corre el árbol por su cuenta, uno tras otro sin devolver el turno al jugador entre medias — sin coordinación táctica compleja (coherente con "determinista simple").
- **Refuerzos** (habilidad propia del Jefe *Capitán Comandante* — ya no depende de la carta *Refuerzos* del mazo de encuentro, retirada por no encajar con el presupuesto de composición, [`../cards/encounter.md`](../cards/encounter.md)) entran **Activos** en el hexágono libre más cercano al combate y actúan desde la fase enemiga siguiente (tiran iniciativa al aparecer para fijar su orden dentro de ella); cuenta contra el mismo presupuesto de composición de abajo, nunca por encima del tope 6.
