...
| **Desventaja** | Tiras 2d20 y coges el **peor** | 1 tirada | Terreno expuesto, Niebla ([`cards/encounter.md`](cards/encounter.md)), **disparar a bocajarro** (ataque a distancia contra un enemigo adyacente, [`board/battle.md`](board/battle.md) §2), armadura ruidosa en la prueba de sigilo ([`cards/armor.md`](cards/armor.md) §5) | Se consume sola |
...
| **Ralentizado** | Movimiento reducido a 1 hex | 1 turno | Terreno, Clima adverso ([`cards/encounter.md`](cards/encounter.md)) | Automático, o salir de la zona |
