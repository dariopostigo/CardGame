...
Documento dedicado a los NPCs **no hostiles** que aparecen en el mapa mediante la Ficha de Personaje ([`board-map.md`](board-map.md), sección "Fichas del tablero"). Distinto de [`enemies.md`](enemies.md) (entidades hostiles) — estos no inician combate.

**Base: arquetipos clásicos de NPC de D&D** (mercader, tabernero, herrero, sabio/mago...), sin atarse a nada de Tolkien/Viajes.
...
|---|---|---|
| Vendedor/Mercader | Compra/vende objetos, pociones, a veces armas/armaduras | El más genérico; aparece tanto en Pueblo como suelto en el mapa |
| Tabernero | Cura PV, quita estados negativos, puede dar rumores/pistas | Ligado normalmente a Pueblo |
...
| Mercenario contratable | Se une temporalmente como aliado (por un tramo del mapa o hasta un descanso) | Tiene un coste (oro/recurso) a cambio de ayuda en combate |
...
| Herrero | Repara/mejora armas y armaduras existentes del mazo | Arquetipo clásico de D&D, contrapunto "físico" al Mago/Encantador (arcano) |
...
- [ ] Definir el sistema de precios/economía (¿qué moneda usa el jugador para comprar/contratar?) — probablemente ligado a un recurso nuevo a definir en `game-design.md`.
