...
Mazo **gestionado por el sistema** (no por el jugador) con cartas cortas que se roban en momentos de tensión de la exploración. Definido en [`../board/board-map.md`](../board/board-map.md) §5 y usado en combate en [`../game-design.md`](../game-design.md) §4b.6 y al acampar en §4c.2. Índice de cartas en [`README.md`](README.md). Valores = **primer pase sin balancear**.
