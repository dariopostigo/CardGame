...
import { DEV_LABS, LAB_STATUS_LABEL, isAvailable, type DevLab } from "@/lib/dev-labs";

// Hub de laboratorios. Sale entero de lib/dev-labs.ts, así que un laboratorio
...
export default function DevIndexPage() {
  const active = DEV_LABS.filter(isAvailable);
  const planned = DEV_LABS.filter((l) => !isAvailable(l));
...
function LabCard({ lab }: { lab: DevLab }) {
