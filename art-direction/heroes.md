# CardGame — Héroes: prompts de ilustración

Un bloque por héroe, listo para copiar y pegar tal cual en una IA de generación de imagen. Estilo base de toda ilustración: [`style-guide.md`](style-guide.md). Ficha narrativa completa (historia, fuertes/débiles, kit) en [`../docs/characters/heroes.md`](../docs/characters/heroes.md) §1b y §2d. Guarda el resultado en [`../public/assets/heroes/`](../public/assets/heroes/README.md) — **no** en `public/assets/cards/class/<heroe>/`, esa carpeta es para las 8 cartas de habilidad de cada héroe, no para su retrato.
