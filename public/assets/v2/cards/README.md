# Ilustraciones de carta de v2 (final, no moodboard)

> **Congelado.** Es el arte del juego anterior. Lo nuevo va en
> [`../../v3/`](../../v3/README.md); el corte, en
> [`../../README.md`](../../README.md).
...
Una por categoría, mismo nombre que su documento en `docs/v2/cards/`:

| Carpeta | Corresponde a |
|---|---|
| `class/<heroe>/` | [`class.md`](../../../../docs/v2/cards/class.md) — subcarpeta por héroe: `guerrero`, `mago`, `picaro`, `clerigo` |
| `weapons/` | [`weapons.md`](../../../../docs/v2/cards/weapons.md) |
| `armor/` | [`armor.md`](../../../../docs/v2/cards/armor.md) |
| `items/` | [`items.md`](../../../../docs/v2/cards/items.md) |
| `curses/` | [`curses.md`](../../../../docs/v2/cards/curses.md) |
| `mercenaries/` | [`mercenaries.md`](../../../../docs/v2/cards/mercenaries.md) |
| `encounter/combat/`, `encounter/event/` | [`encounter.md`](../../../../docs/v2/cards/encounter.md) — las dos pilas del mazo (§3 Combate, §4 Suceso) |
...
Extensión `.webp` (igual que el resto de `public/assets/`; misma norma en `v3/`). Si la IA solo entrega `.png`, vale igual mientras se decide el pipeline de conversión — no hace falta bloquear por esto para ir guardando.
